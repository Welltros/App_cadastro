...
#abrindo imagem
app_img = Image.open('img\\casa.png')
...
b_update = Button(frameMeio,command=deletar, image=img_delete , width=95, text='   Deletar'.upper(), compound=LEFT, anchor=NW,overrelief=RIDGE,font=('Ivy 8'),bg=co1, fg=co0)
b_update.place(x=330, y=90)

# Ver imagem 

img_item = Image.open('img\\item.png')
